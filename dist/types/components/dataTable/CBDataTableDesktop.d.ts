 ...
 * ```
 */
declare function CBDataTableDesktop<T>({ columns, data, pageSize, emptyMessage, getRowId, onEdit, onDelete, selectionMode, theme, page, totalRows, onPageChange, onPageSizeChange, loading, singleClickEdit, stopEditingWhenCellsLoseFocus, onCellValueChanged, autoFocusFirstEditableCell, actions, }: CBDataTableProps<T>): import("react").JSX.Element;
