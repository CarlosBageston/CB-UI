...
declare function CBDataTableMobile<T>({ columns, data, pageSize, emptyMessage, getRowId, onEdit, onDelete, selectionMode, theme, themeConfig, page, totalRows, onPageChange, onPageSizeChange, loading, defaultExpanded, singleClickEdit, onCellValueChanged, autoFocusFirstEditableCell, }: CBDataTableMobileProps<T>): import("react").JSX.Element;
