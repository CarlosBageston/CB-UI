...
import { useMemo as h, useCallback as c, useState as z } from "react";
import { G as s, u as y } from "./iconBase-DZ-AbiPG.js";
function it(t) {
  return s({ attr: { viewBox: "0 0 512 512" }, child: [{ tag: "path", attr: { fill: "none", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "32", d: "M256 112v288m144-144H112" } }] })(t);
}
function ct(t) {
  return s({ attr: { viewBox: "0 0 512 512" }, child: [{ tag: "path", attr: { fill: "none", strokeLinecap: "square", strokeMiterlimit: "10", strokeWidth: "48", d: "M112 184l144 144 144-144" } }] })(t);
}
function ut(t) {
  return s({ attr: { viewBox: "0 0 512 512" }, child: [{ tag: "path", attr: { d: "M289.94 256l95-95A24 24 0 00351 127l-95 95-95-95a24 24 0 00-34 34l95 95-95 95a24 24 0 1034 34l95-95 95 95a24 24 0 0034-34z" } }] })(t);
}
function X(t) {
...
const dt = ({
  ...
  const [E, b] = z(!1), { main: g } = y(N, F), { main: w } = y("danger"), { show: I, toggle: O, inputType: P } = et();
  console.log("mainColor", g), console.log("errorColor", w);
  const { handleChange: C, inputMode: R } = rt(j, A, L), M = h(() => $(t), [t]), v = o === "password", V = i ? w : E || !!M ? g : "var(--cb-color-border)", W = c(
    (U) => {
      C($(U.target.value));
    },
    [C]
  ...
  return /* @__PURE__ */ Z("div", { className: `relative flex flex-col h-18 pt-2 mb-3! ${f}`, children: [
    /* @__PURE__ */ a(
      J,
      {
        ...G,
        ...
        style: {
          "--border-color": V,
          "--highlight-color-focused": g,
          "--border-radius": H[D || "md"],
          color: k ?? "var(--cb-color-dark)",
          ...p
        },
        onIonInput: W,
        onIonFocus: () => {
    ...
    v && /* @__PURE__ */ a(
      K,
      {
        ...
        children: I ? /* @__PURE__ */ a(
          Y,
          {
            className: `text-2xl text-(--cb-color-dark) ${x}`
          }
        ) : /* @__PURE__ */ a(
          X,
          {
