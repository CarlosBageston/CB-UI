...
import { IonButton as M, IonSpinner as D } from "@ionic/react";
import "react";
import { u as G, G as a } from "./iconBase-CU6crY-n.js";
const q = ({
  children: t,
  size: h = "medium",
  variant: e = "solid",
  ...
  return /* @__PURE__ */ d(
    M,
    {
      ...
      children: s ? /* @__PURE__ */ u(f, { children: [
        /* @__PURE__ */ d(D, { name: "crescent", slot: "start" }),
        x ?? t
