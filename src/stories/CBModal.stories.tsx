...
export const UserEditModal: Story = {
  render: () => {
    ...
    const [bio, setBio] = useState(
      "Desenvolvedor fullstack apaixonado por React e Ionic.",
    );
    ...
    return (
      <div className="p-6">
        <CBButton children="Editar Usuário" onClick={() => setOpen(true)} />
        ...
        <CBModal
          ...
          footer={
            <div className="flex justify-end gap-2">
              ...
              />
              <CBButton children="Salvar" onClick={handleSave} />
            </div>
          }
        ...
        >
          <div className="flex flex-col gap-4">
            <div className="!mt-2">
              <CBInput label="Nome" onChangeValue={setName} value={name} />
            </div>
